<!-- ALL GABE -->
<!-- This file allows the users to add new items to a project -->
<?php
    ...
    // Query item data for details on the item being added
    $sql = "SELECT
                items.item_id,
                items.name,
                items.description,
    ...
    // Row is one entry, and it contains the details on the item being added
    ...
    if (isset($_POST['submit'])) {
        ...
        if($quantity < 1){
            ...
            // Calculate total cost and insert new item assignment into table
            $total_cost = (int)$quantity * $row['cost'];        
            $sql = "INSERT INTO `item assignments` (project_id, item_id, quantity, total_cost) VALUES ($proj_id, $item_id, $quantity, $total_cost)";
